...
class Crawler:
    ...
    def get_images(self, word='图'):
        ...
        while pn < self.__amount:
            ...
            #url = 'http://cn.bing.com/images/search/avatarjson?tn=resultjsonavatarnew&ie=utf-8&word=' + search + '&cg=girl&pn=' + str(
           # pn) + '&rn=60&itg=0&z=0&fr=&width=&height=&lm=-1&ic=0&s=0&st=-1&gsm=1e0000001e'
...
if __name__ == '__main__':
    ...
    crawler.start('海警船', 8, 1)  # 抓取关键词为 ，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
